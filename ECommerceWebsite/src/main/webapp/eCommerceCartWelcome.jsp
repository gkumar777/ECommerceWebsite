...
<body>
      <div class="about-section">
        <div class="inner-width">
          <h1 style="color:#ff9800!important"><b>Welcome to the ECommerce Cart Portal</b></h1>
          ...
          <div class="about-section-row">
            ...
            <div class="about-section-col">
            <h2 style="color:#ff9800!important;" >We have Best Category of Products as per User's Ratings</h2>
              <div class="skills">
                <div class="skill">
                  <div class="title" style="color: blue;"><b>Sporty Shoes along with Normal Shoes</b></div>
                  <div class="progress">
                ...
                <div class="skill">
                  <div class="title" style="color: blue;"><b>Laptops Category</b></div>
                  <div class="progress">
                ...
                <div class="skill">
                  <div class="title" style="color: blue;"><b>Mobiles Category</b></div>
                  <div class="progress">
                    <div class="progress-bar p2"><span>79.30%</span></div>
                  </div>
                </div>
                <div class="skill">
                  <div class="title" style="color: blue;"><b>Kitchens-Things Category</b></div>
                  <div class="progress">
                ...
                <div class="skill">
                  <div class="title" style="color: blue;"><b>Clothes Category</b></div>
                  <div class="progress">
